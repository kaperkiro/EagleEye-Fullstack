...
class CameraDiscovery:
    def __init__(self, base_ip: str = "192.168.0.", start_range: int = 90, 
                 end_range: int = 100, username: str = "student", 
    ...
    def _test_rtsp(self, ip: str) -> bool:
        ...
        os.environ["OPENCV_FFMPEG_CAPTURE_OPTIONS"] = "rtsp_transport;tcp|timeout=3000|fflags=nobuffer|probesize=1000000|analyzeduration=2000000"
    ...
    def discover(self) -> List[Tuple[int, str]]:
        ...
        threads = []
        logger.info(f"Scanning IP range {self.base_ip}{self.start_range}-{self.end_range}")
